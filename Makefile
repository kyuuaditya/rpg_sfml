...
link: 
	g++ -I"C:\SFML-2.6.2\include" .\app.o .\player.o .\skeleton.o .\math.o .\stats.o -o app.exe -L"C:\SFML-2.6.2\lib" -lmingw32 -lsfml-graphics -lsfml-window -lsfml-system -lsfml-main 
